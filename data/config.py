...
ddir = os.path.join(home,"workspace/dataset/voc/VOCdevkit")
...
v2 = {
    ...
    '512':{
        'feature_maps_min' : [64, 32, 16, 8, 6, 4, 2],

        'feature_maps_max' : [96, 48, 24, 12, 10, 8, 6],
    ...
    '384':{
        'feature_maps_min' : [48, 24, 12, 6, 4, 2],

        'feature_maps_max' : [96, 48, 24, 12, 10, 8],
